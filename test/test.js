...
// let cake;
describe("ETBToken : ", function () {
  it("ETBToken is deployed for the unit-test", async function () {
    const ETB = await ethers.getContractFactory("ETB");
    const etb = await ETB.deploy();
    await etb.deployed();

    expect(
      await etb.balanceOf("0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266")
